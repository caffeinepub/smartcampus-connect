...
import { GraduationCap, BrainCircuit, Building2, HeartHandshake, Eye, EyeOff, ArrowLeft, LogIn } from 'lucide-react';
...
const roleConfigs: Record<UserRole, RoleConfig> = {
  student: {
    ...
    bgGradient: 'linear-gradient(135deg, oklch(0.18 0.05 165) 0%, oklch(0.22 0.07 180) 100%)',
  ...
  teacher: {
    ...
    bgGradient: 'linear-gradient(135deg, oklch(0.18 0.04 240) 0%, oklch(0.22 0.06 260) 100%)',
    placeholder: { username: 'teacher@school.edu', password: 'Enter password' },
    welcomeText: 'Manage your classes, AI tools, and student performance insights.',
  },
  institute: {
    label: 'Institute',
    ...
    bgGradient: 'linear-gradient(135deg, oklch(0.16 0.04 255) 0%, oklch(0.20 0.06 240) 100%)',
    placeholder: { username: 'admin@institute.edu', password: 'Enter password' },
    welcomeText: 'Oversee campus governance, infrastructure, and institutional analytics.',
  },
  parent: {
    label: 'Parent',
    ...
    bgGradient: 'linear-gradient(135deg, oklch(0.18 0.04 235) 0%, oklch(0.22 0.06 220) 100%)',
    placeholder: { username: 'parent@email.com', password: 'Enter password' },
    welcomeText: "Track your child's progress, attendance, fees, and connect with teachers.",
  },
};
...
export default function RoleLoginPage({ role, onLogin, onBack }: RoleLoginPageProps) {
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                style={{ borderColor: username ? config.borderColor : undefined }}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  style={{ borderColor: password ? config.borderColor : undefined }}
