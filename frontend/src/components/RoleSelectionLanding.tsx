import { GraduationCap, BrainCircuit, Building2, HeartHandshake, ArrowRight } from 'lucide-react';
...
const roleCards: RoleCard[] = [
  {
    role: 'student',
    label: 'Student',
    description: 'Access your academics, exams, goals, teams, marketplace, and feedback.',
    icon: GraduationCap,
  ...
  },
  {
    role: 'teacher',
    label: 'Teacher',
    description: 'Manage classes, AI teaching tools, student performance, and faculty resources.',
    icon: BrainCircuit,
  ...
  },
  {
    role: 'institute',
    label: 'Institute',
    description: 'Oversee campus governance, infrastructure, placements, and analytics.',
    icon: Building2,
  ...
  },
  {
    role: 'parent',
    label: 'Parents',
    description: "Track your child's progress, attendance, fees, and connect with teachers.",
    icon: HeartHandshake,
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, oklch(0.18 0.04 240) 0%, oklch(0.22 0.06 200) 50%, oklch(0.16 0.05 260) 100%)',
        }}
      >
        {/* Background pattern */}
        <div
        ...
        <div className="relative max-w-5xl mx-auto px-6 py-16 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4 tracking-tight">
            ...
            <span
              style={{
                background: 'linear-gradient(90deg, oklch(0.75 0.16 165), oklch(0.72 0.14 200))',
          ...
          <p className="text-lg text-white/70 max-w-xl mx-auto leading-relaxed">
            Your complete campus intelligence platform. Select your role to get started.
          </p>
        </div>
      </div>
