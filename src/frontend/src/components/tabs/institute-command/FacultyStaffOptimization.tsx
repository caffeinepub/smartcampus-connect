...
const facultyData: Faculty[] = [
  {
    ...
    dept: "CSE",
    teachingScore: 94,
    contributionIndex: 92,
    researchCount: 8,
    feedbackRating: 4.8,
    classEngagement: 96,
    subjectCompletion: 98,
    isWeak: false,
    trainingRec: "",
  },
  {
  ...
  },
  {
    ...
    dept: "Civil",
    teachingScore: 82,
    contributionIndex: 78,
    researchCount: 3,
    feedbackRating: 4.4,
    classEngagement: 84,
    subjectCompletion: 90,
    isWeak: false,
    trainingRec: "",
  },
  {
    ...
    dept: "EEE",
    teachingScore: 79,
    contributionIndex: 72,
    researchCount: 2,
    feedbackRating: 4.2,
    classEngagement: 80,
    subjectCompletion: 88,
    isWeak: false,
    trainingRec: "",
  },
  {
  ...
  },
  {
    ...
    dept: "IT",
    teachingScore: 71,
    contributionIndex: 60,
    researchCount: 1,
    feedbackRating: 3.8,
    classEngagement: 70,
    subjectCompletion: 80,
    isWeak: false,
    trainingRec: "Advanced Pedagogy Workshop, Digital Teaching Tools",
  },
  {
    id: 9,
    ...
    dept: "Mechanical",
    teachingScore: 62,
    contributionIndex: 52,
    researchCount: 0,
    feedbackRating: 3.4,
    classEngagement: 60,
    subjectCompletion: 72,
    isWeak: true,
    trainingRec:
      "Research Methodology, Student Engagement Techniques, Subject Mastery Refresher",
  },
  {
    id: 10,
    name: "Prof. Rekha Verma",
    dept: "Civil",
    teachingScore: 58,
    contributionIndex: 48,
    researchCount: 0,
    feedbackRating: 3.1,
    classEngagement: 55,
    subjectCompletion: 68,
    isWeak: true,
    trainingRec:
      "Communication Skills, Modern Teaching Methods, Industry Connect Program",
  },
  {
    id: 11,
    name: "Dr. Mohan Das",
    dept: "EEE",
    teachingScore: 55,
    contributionIndex: 44,
    researchCount: 0,
    feedbackRating: 2.9,
    classEngagement: 52,
    subjectCompletion: 65,
    isWeak: true,
    trainingRec:
      "Leadership in Education, Research Writing, Classroom Management",
  },
];
